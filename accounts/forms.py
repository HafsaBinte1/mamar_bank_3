...
class UserRegistrationForm(UserCreationForm):
    # user jate callender dekhte pay
    ...
    class Meta:
        model = User
        fields = ['username', 'password1', 'password2', 'first_name', 'last_name', 'email', 'account_type', 'birth_date','gender',  'city','country', 'street_address']
